...
def add_preprocess_args(parser):
    ...
    group.add_argument("--segdict", metavar="FP",
                       help="reuse given source segmentation dictionary")
    group.add_argument("--nwordsseg", metavar="N", default=-1, type=int,
                       help="number of source segmentation words to retain")
