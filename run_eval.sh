...
CUDA_VISIBLE_DEVICES=2 python generate.py mydata/data-bin/nmt_seg_bin --source-lang ti --target-lang zh --seg-lang seg --task seg_translation --log-format simple --log-interval 10 --path checkpoints/exp5_1/checkpoint220.pt --batch-size 1 --beam 5 --remove-bpe --results-path temp --lenpen 0.6 --max-len-a 1 --max-len-b 50
